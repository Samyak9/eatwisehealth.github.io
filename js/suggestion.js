$( function() {
    ...
    $('.commonFood').click(()=>{
        availableTags = [];
        commonFoods.map((x)=>{
          availableTags.push(toTitleCase(x.Name));
        });
        changeColor('commonFood');
    ...
    var changeColor = function(class1){
      var set = ['commonFood','pulses','vegetables','roots','nuts','milk','spices','fruits','sugars','fatty'];
      var index = set.indexOf(class1);
      if(index > -1){
        set.splice(index, 1);
      }
      ...
      $('.'+class1).removeClass('btn-primary');
      $('.'+class1).addClass('btn-success');
    }
    ...
    $('.d1Eval').click(function(){
        var x = [];
        $('.d1').each(function(i){
            x.push($(this).children().val());
        });

        console.log(x);
    })

    $( "#tags-1, #tags-2,#tags-3,#tags-4,#tags-4,#tags-5,#tags-6,#tags-7" )
